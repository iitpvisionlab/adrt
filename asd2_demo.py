#!/usr/bin/env python3
from asd2 import asd2, Image
import numpy as np
from PIL import Image as PILImage


def process(src: str, dst: str, rot90: int, flip_hor: bool, flip_ver: bool):
    ...
    if arr.ndim == 2:
        ...
        res = asd2(w, h, rotated_arr.tolist())
        out.append(res)
    elif arr.ndim == 3:
...
def main():
    ...
    parser.add_argument("dst", nargs='?', help="destination image", default="SheppLogan_Phantom_Out.png")
